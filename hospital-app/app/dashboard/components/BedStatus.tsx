      ...
      <div className="relative">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between items-center p-3 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl border border-emerald-200 hover:shadow-md transition-all">
            ...
            <span className="font-bold text-xl text-emerald-600">12</span>
          </div>
        ...
        <div className="mt-6">
          ...
          <div className="h-3 bg-slate-100 rounded-full overflow-hidden shadow-inner">
            <div className="h-3 bg-gradient-to-r from-[#3b82f6] to-[#60a5fa] rounded-full w-[70%] shadow-md transition-all" />
          </div>
        </div>
      </div>
    </div>
